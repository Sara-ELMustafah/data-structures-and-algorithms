...
const getNames = (arr) => {
  // Solution code here...
  // split the string by the space into an array by using the split() string method.
  // concatenate all elements in the result array into a string by using the join() method.
